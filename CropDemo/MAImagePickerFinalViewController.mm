...
- (void)viewDidLoad
{
    ...
    [_finalImageView setFrame:CGRectMake(0, 10, self.view.bounds.size.width, self.view.bounds.size.height - (kCameraToolBarHeight + 70))];
...
- (void)storeImageToCache
{
    ...
    UIViewController *viewController1 = [[UIViewController alloc]initWithNibName:@"ViewController" bundle:nil];
}
